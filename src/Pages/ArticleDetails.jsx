...
const ArticleDetails = () => {
  return (
    <div>
                 <Helmet>
        <title>Office Space | Artical Details</title>
        <meta
          name="description"
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <img className="img-fluid mt-5 mb-3" src="images/article-details-large.jpg" alt="alternative"/>
                </div>
            </div>
        </div>
    </div> 
        ...
        <div className="container">
            <div className="row">
                <div className="col-xl-10 offset-xl-1">
                    ...
                    <img className="img-fluid mb-5" src="images/article-details-small.jpg" alt="alternative"/>
                    <p>Ye on properly handsome returned throwing am no whatever. In without wishing he of picture no exposed talking minutes. Curiosity continual belonging offending so explained it exquisite. Do remember to followed yourself material mr recurred carriage. Way mrs end gave fat skin brown yesterday tall walk fact bed.</p>
                    <p className="mb-5">High drew west we no or at john. About or given on witty event. Or sociable up material bachelor bringing landlord confined. Busy so many in hung easy find well up. So of exquisite my an explained remainder. Dashwood denoting securing be on perceive my laughing so. Ye on properly handsome returned throwing am no whatever.</p>
                    ...
                    <a className="btn-solid-reg mb-5" href="index.html#contact">Contact us</a>
                </div>
            </div>
        </div>
    </div>
